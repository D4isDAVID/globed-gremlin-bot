...
import editQuote from './command/edit-quote/context.js';
import editQuoteModal from './command/edit-quote/modal.js';
...
export default {
    ...
    modals: [editNewGremlinQuoteModal, editQuoteModal],
} satisfies Component;
